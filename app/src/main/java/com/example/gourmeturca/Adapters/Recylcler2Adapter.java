...
public class   Recylcler2Adapter extends RecyclerView.Adapter<Recylcler2Adapter.ViewHolder> {

    private Context mContext;
    private List<Datum1> productResponseList;
    GlobalMethods globalMethods = new GlobalMethods();

    public Recylcler2Adapter(Context mContext, List<Datum1> productResponseList) {
    ...
    @NonNull
    @Override
    public Recylcler2Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_card, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Recylcler2Adapter.ViewHolder holder, int position) {
